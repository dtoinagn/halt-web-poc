 ...
 import {
   ...
   TableRow, Paper, FormControl, InputLabel, Select, MenuItem, TableSortLabel
 } from '@mui/material';
 import 'react-multi-carousel/lib/styles.css';
 import 'reactjs-popup/dist/index.css';

 
export default function PendingTableTemplate({pendingData}) {
    const keyMap = {
      "Halt ID": "haltId",
      "Symbol": "symbol",
    ...
    const defaultOrderBy = localStorage.getItem("pendingOrderBy") || "haltTime";
    const defaultOrderDirection = localStorage.getItem("pendingOrderDirection") || "desc";
    ...
    const sortedRows = sortRows(pendingData);
    return (
      <div>
        <Box
          sx={{
            ...
            <FormControl sx={{ minWidth: 140 }}>
              ...
              <Select
                ...
                onChange={(e) => {
                  ...
                  setOrderBy(val);
                  localStorage.setItem("pendingOrderedBy", val);
                }}
              >
            ...
            <FormControl sx={{ minWidth: 140 }}>
              ...
              <Select
                ...
                onChange={(e) => {
                  ...
                  localStorage.setItem("pendingOrderDirection", val);
                }}
              >
      ...
      <TableContainer component={Paper} sx={{ backgroundColor: '#7d9c9c', marginTop: 7, maxHeight: 580, overflowY: 'auto' }}>
            <Table stickyHeader>
              ...
              <TableRow sx={{ backgroundColor: '#006666' }}>
                  {['Halt ID', 'Symbol', 'Issue Name', 'Listing Market', 'All Issues', 'Created By', 'Halt Time', ' ', '   '].map((head) => (
              ...
              {sortedRows.map((row, idx) => (
                  ...
                  <TableCell><button>Edit Halt</button></TableCell>
                  <TableCell><button>Cancel Halt</button></TableCell>
                  </TableRow>
              ))}
              </TableBody>
          </Table>
